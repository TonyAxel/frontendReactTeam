...
import {setCountProduct} from "../../../store/AuthSlice";
...
const Header = () => {
    ...
    const showMenuCategory = () => {
        document.documentElement.setAttribute('show-popup-category', 'true');
    }
            ...
            <div className="header__right">
                {
                    ...
                    <Link to='/cart' className='header__right_cart'>
                        <div className='icon_cart'>
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#1B81BA"
                ...
                <div className="header__right_map">
                    <div className='icon_map'>
                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#1B81BA"
                ...
                </div>
                {
                    ...
                    user.id ?
                        <Link to='/profile' className="header__right_person" >
