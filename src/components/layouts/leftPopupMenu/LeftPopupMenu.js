...
import {setErrorAuth, setUser} from "../../../store/AuthSlice";
import PopupInfoAuth from "../../popup/popupInfoAuth/PopupInfoAuth";
import AxiosClient from "../../../axiosClient/AxiosClient";

const LeftPopupMenu = qualifiedName => {

    const {errorAuth, user} = useSelector(state => state.authReducer)
    const closeLeftMenu = () => {
    ...
    useEffect(() => {
        ...
        const time = setInterval(() => (dispatch(setErrorAuth(false))), 5000)
    ...
    return (
        <>
                            ...
                            <div className="icon_close" onClick={() => closeLeftMenu()}>
                                <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    <g id="SVGRepo_iconCarrier">
                                        <path d="M19 5L4.99998 19M5.00001 5L19 19" stroke="#ffffff" strokeWidth="2.4"
                            ...
                            <div className="information">
                                {
                                    user.id
                                        ?
                                        <h3 style={{cursor: "pointer"}} onClick={() => logout()}>Выйти</h3>
                                        :
                                        <>
                                            <>
                        ...
                        <div className="content">
                            <div className="icon_content">
                                <div className="icon_cart">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="32" fill="black"
                                         className="bi bi-basket3" viewBox="0 0 20 20">
                                        <path
                            ...
                            <div className="icon_content"
                                 style={{paddingBottom: '20px', borderBottom: '1px solid #CFCFCF'}}>
                                <div className="icon_cart">
            ...
            {
                errorAuth &&
                createPortal(<PopupInfoAuth/>, document.body)
            }
        </>
    )
}
